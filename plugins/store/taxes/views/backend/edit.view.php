...
<h2><?php echo __('Edit Shipping Tax', 'taxes'); ?></h2>
<br/>
<?php
 if (isset($errors['page_error']))
 {
   ...
   echo Form::open().
        Form::submit('cancel', __('Back', 'taxes'), array('class' => 'btn')).
        Form::close();
 }
 else
 {
   ...
   echo (
         Html::br(2).
         Form::submit('edit_tax_and_exit', __('Save and exit', 'taxes'), array('class' => 'btn')).Html::nbsp(2).
         Form::submit('edit_tax', __('Save', 'taxes'), array('class' => 'btn')).Html::nbsp(2).
