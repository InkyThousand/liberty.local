...
<h2><?php echo __('Add New State', 'countries') ?></h2>
<br/>
<?php
 ...
 echo Html::br(2).
      Form::submit('add_state_and_exit', __('Save and exit', 'countries'), array('class' => 'btn')).Html::nbsp(2).
      Form::submit('add_state', __('Save', 'countries'), array('class' => 'btn')).Html::nbsp(2).
