...
<h2><?php echo __('New Price Type', 'price-types'); ?></h2>
<br/>
<?php 
 ...
 echo (
       ...
       Form::input('price_type_sign', $price_type_currency, array('maxlength' => 10, 'class' => 'span6', 'id' => 'price_type_sign', 'style' => 'width:100px'))
      );
 echo (
 ...
 echo (
       Html::br(2).
       Form::submit('add_price_type_and_exit', __('Save and exit', 'price-types'), array('class' => 'btn')).Html::nbsp(2).
       Form::submit('add_price_type', __('Save', 'price-types'), array('class' => 'btn')).Html::nbsp(2).
