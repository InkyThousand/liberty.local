...
<html lang="en">
    ...
    <body class="login-body">
        ...
        <div class="container form-signin">
            ...
            <div style="text-align:center;"><a class="brand" href="<?php echo Option::get('siteurl'); ?>admin"><img src="<?php echo Option::get('siteurl'); ?>public/assets/img/logo.png" height="31" width="230"></a></div>
