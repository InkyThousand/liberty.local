...
class Text
{
     ...
     *
     *  <code>
     *      echo Text::trimStr(' test 12345678 ', 10);
     *  </code>
     *
     * @param  string $str String
     ...
     * @return string
     */
    public static function trimStr($str, $length = null)
    {
      $str = (string) $str;
      if ($length)
      {
      ...
      {
        return strlen($trimmed_str) > $length ? function_exists('mb_substr') ? mb_substr($trimmed_str, 0, $length, 'utf-8') : substr($trimmed_str, 0, $length) : $trimmed_str;
      }
    }
