...
class Arr
{
    ...
    /**
     * Clears array assotiations
     *
     *  <code>
     *      Arr::arrayUnset($array, $key1, $key2, ...);
     *  </code>
     *
     * @param   array   $array  Array to unset
     */
    public static function arrayUnset(&$array)
    {
    ...
    /**
     * Changes case of array elements
     *
     *  <code>
     *      Arr::array_change_value_case($array, CASE_LOWER);
     *  </code>
     *
     * @param   array   $array  Array to check
     * @param   int     $case   Case type
     * @return  array
     */
    public static function changeValueCase($array, $case = CASE_UPPER)
    {
      $aRet = array();
