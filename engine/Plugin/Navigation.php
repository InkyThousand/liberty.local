            ...
            foreach ($items as $item) 
            {
                if (is_array($item['name']))
                {
                    if ($item['category'] == $category && $item['type'] == Navigation::LEFT)  
                    {
                      ...
                      {
                        if (Request::get('id') == $item['id'][0])
                        {
                          if (Valid::hasValue(Request::get('mode')))
                          {
                            if (Request::get('mode') == $item['id'][$i]) $class = 'class = "current" '; else $class = '';
                          }
                          else
                          {
                            if ($i == 1) $class = 'class = "current" '; else $class = '';
                          }
                        }
                        ...
                        echo '<li><a '.$class.'href="index.php?id='.$item['id'][0].'&amp;mode=' . $item['id'][$i]. '"><span style="margin-left:35px">'.$item['name'][$i].'</span></a></li>';
                      }
