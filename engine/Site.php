...
class Site
{
    ...
    /**
     * Get site root related to server's root folder
     *
     *  <code> 
     *      echo Site::root();
     *  </code>
    ...
    public static function root() {
      $str = str_replace('\\', '/', substr(realpath(ROOT), strlen(realpath($_SERVER['DOCUMENT_ROOT']))));
      return $str;
    }

    
    /**
     * Get theme root from server's root folder
     *
     *  <code> 
     *      echo Site::root();
     *  </code>
    ...
    public static function themeRoot() {
      $str = '/' . trim(str_replace('\\', '/', substr(realpath(THEMES_SITE), strlen(realpath($_SERVER['DOCUMENT_ROOT'])))), '/') . '/' . self::theme();
      return $str;
    }
