 ...
 * Set password salt
 */
define('MONSTRA_PASSWORD_SALT', 'liberty pumps dealerstore');
...
/**
 * Set date format for displaying pages data
 */
define('MONSTRA_PAGES_DATE_FORMAT', 'n/j/Y');

/**
 * Set date format for exception log
 */
define('MONSTRA_LOG_DATE_FORMAT', 'Y/m/d H:i:s');
